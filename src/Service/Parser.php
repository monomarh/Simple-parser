    ...
    public static function getPage($arParams = [])
    {
        if ($arParams) {
            if (!empty($arParams['url'])) {
                $sUrl = $arParams['url'];
                $sUserAgent = !empty($arParams['useragent']) ? $arParams['useragent'] : 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.113 Safari/537.36';
